...
public interface UpdateTopK {
    ...
    ResultSet updateTopK(@Param("p") String prefix, @Param("t") Set<CompletionCount> completionCounts,
    ...
    ResultSet updateTopKIfVersionIsNull(@Param("p") String prefix, @Param("t") Set<CompletionCount> completionCounts);
}
